...
def build_node(inorder: List[int], in_start:int, in_end: int,postorder: List[int], post_start:int, post_end:int) -> Optional[TreeNode]:
    ...
    root.left = build_node(inorder, left_in_start, left_in_end, postorder, left_post_start, left_post_end)
    root.right =build_node(inorder, right_in_start, right_in_end, postorder, right_post_start, right_post_end)
    return root
