...
def build_node(
    ...
    print(
        f"{desc}: inorder s={inorder_start} e:{inoder_end} {inorder_list[inorder_start:inoder_end]}"
    )
    print(
        f"{desc}: post    s={inorder_start} e:{inoder_end} {postorder_list[0:root_node_index[0]+1]}"
    )
