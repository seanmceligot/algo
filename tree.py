...
class TreeNode:
    def __init__(self, val: int, left: Optional[Self] =None, right: Optional[Self] =None):
        self.val = val
        self.left = left
        self.right = right
    def __repr__(self):
...
def new_node(val: Any, left: Optional[TreeNode] =None, right: Optional[TreeNode] =None) -> TreeNode:
